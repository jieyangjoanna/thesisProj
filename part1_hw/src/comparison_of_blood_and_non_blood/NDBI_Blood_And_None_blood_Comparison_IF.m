...
%{
% Index 1
Wvl1 = 950-350+1;% feature at wavelength1 950nm, spectrum starts at 350nm
Wvl2 = 1200-350+1; %1200nm feature
%}
% Index 2
%{
Wvl1 = 950-350+1;% feature at wavelength1 950nm, spectrum starts at 350nm
Wvl2 = 1280-350+1; %1280nm feature
%}
% Index 3
Wvl1 = 600-350+1;% feature at wavelength1 600nm, spectrum starts at 350nm
Wvl2 = 700-350+1; %700nm feature
...
%%%%%%%%%%%%%%%%%%%%% 4ML Petri Dish   %%%%%%%%%%%%%%
%%% Petri dish
INDEX1_BLD_4_P = (blood_4_av(BS_Wvl1)-blood_4_av(BS_Wvl2))./(blood_4_av(BS_Wvl1)+blood_4_av(BS_Wvl2));
INDEX1_AVD_4_P = (AVD_4_P_av(BS_Wvl1)-AVD_4_P_av(BS_Wvl2))./(AVD_4_P_av(BS_Wvl1)+AVD_4_P_av(BS_Wvl2));
INDEX1_CO_4_P = (CO_4_P_av(BS_Wvl1)-CO_4_P_av(BS_Wvl2))./(CO_4_P_av(BS_Wvl1)+CO_4_P_av(BS_Wvl2));
INDEX1_COF_4_P = (COF_4_P_av(BS_Wvl1)-COF_4_P_av(BS_Wvl2))./(COF_4_P_av(BS_Wvl1)+COF_4_P_av(BS_Wvl2));
INDEX1_K_4_P = (K_4_P_av(BS_Wvl1)-K_4_P_av(BS_Wvl2))./(K_4_P_av(BS_Wvl1)+K_4_P_av(BS_Wvl2));
INDEX1_OJ_4_P = (OJ_4_P_av(BS_Wvl1)-OJ_4_P_av(BS_Wvl2))./(OJ_4_P_av(BS_Wvl1)+OJ_4_P_av(BS_Wvl2));
INDEX1_PD_4_P = (PD_4_P_av(BS_Wvl1)-PD_4_P_av(BS_Wvl2))./(PD_4_P_av(BS_Wvl1)+PD_4_P_av(BS_Wvl2));
INDEX1_RW_4_P = (RW_4_P_av(BS_Wvl1)-RW_4_P_av(BS_Wvl2))./(RW_4_P_av(BS_Wvl1)+RW_4_P_av(BS_Wvl2));
INDEX1_T_4_P = (T_4_P_av(BS_Wvl1)-T_4_P_av(BS_Wvl2))./(T_4_P_av(BS_Wvl1)+T_4_P_av(BS_Wvl2));
INDEX1_TS_4_P = (TS_4_P_av(BS_Wvl1)-TS_4_P_av(BS_Wvl2))./(TS_4_P_av(BS_Wvl1)+TS_4_P_av(BS_Wvl2));

figure('color', 'w'); hold on; 
ax=gca;
ax.FontSize=14;
plot(angle, INDEX1_BLD_4_P, 'ro');
plot(angle, INDEX1_AVD_4_P, 'ks');
plot(angle, INDEX1_CO_4_P, 'ks');
plot(angle, INDEX1_COF_4_P, 'ks');
plot(angle, INDEX1_K_4_P, 'ks');
plot(angle, INDEX1_OJ_4_P, 'ks');
plot(angle, INDEX1_PD_4_P, 'ks');
plot(angle, INDEX1_RW_4_P, 'ks');
plot(angle, INDEX1_T_4_P, 'ks');
plot(angle, INDEX1_TS_4_P, 'ks');
xlabel('Angle (degree)');
ylabel('Index3');
...
ax.FontSize=14;
%{
plot(10.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(20.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(30.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(40.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(50.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(60.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(70.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(80.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(90.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(100.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(110.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(120.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(130.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(140.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(150.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(160.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(170.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(180.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(190.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(200.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
plot(210.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');

%plot(220.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
%plot(230.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
%plot(240.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
%plot(250.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
%plot(260.5*ones(1,length(-0.6:0.005:1)), -0.6:0.005:1, 'k-');
%}


plot(10.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(20.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(30.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(40.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(50.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(60.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(70.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(80.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(90.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(100.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(110.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(120.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(130.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(140.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(150.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(160.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(170.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(180.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(190.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(200.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
plot(210.5*ones(1,length(-1:0.005:0.5)), -1:0.005:0.5, 'k-');
%plot(220.5, -1:0.005:0.5, 'k-');
%plot(230.5, -1:0.005:0.5, 'k-');
%plot(240.5, -1:0.005:0.5, 'k-');
%plot(250.5, -1:0.005:0.5, 'k-');
%plot(260.5, -1:0.005:0.5, 'k-');
%}
title('Blood Separation from Liquid Confusors'); xlabel('Samples Representation');ylabel('Index3');
xlim([0 211]);
%ylim = ([-0.6 1]);
%LINESTYLE = {'G*','B*','M*', 'C*', 'Y*', 'K*', rgb('orange'),rgb('DarkRed'), rgb('')};

h(10)=scatter(1*ones(21,1), INDEX1_BLD_4_P, 'r', 'filled');

h(1) = plot(2*ones(21,1), INDEX1_AVD_4_P, '*');
h(2) = plot(3*ones(21,1), INDEX1_CO_4_P, '*');
h(3) = plot(4*ones(21,1), INDEX1_COF_4_P, '*');
h(4) = plot(5*ones(21,1), INDEX1_K_4_P, '*');
h(5) = plot(6*ones(21,1), INDEX1_OJ_4_P, '*');
h(6) = plot(7*ones(21,1), INDEX1_PD_4_P, '*');
h(7) = plot(8*ones(21,1), INDEX1_RW_4_P, '*');
h(8) = plot(9*ones(21,1), INDEX1_T_4_P, '*');
h(9) = plot(10*ones(21,1), INDEX1_TS_4_P, '*');
...
%%%%%%%%%%%%%%%%%%%%% 10ML Petri Dish   %%%%%%%%%%%%%%
%%% Petri dish
INDEX1_BLD_10_P = (blood_10_av(BS_Wvl1)-blood_10_av(BS_Wvl2))./(blood_10_av(BS_Wvl1)+blood_10_av(BS_Wvl2));
INDEX1_AVD_10_P = (AVD_10_P_av(BS_Wvl1)-AVD_10_P_av(BS_Wvl2))./(AVD_10_P_av(BS_Wvl1)+AVD_10_P_av(BS_Wvl2));
INDEX1_CO_10_P = (CO_10_P_av(BS_Wvl1)-CO_10_P_av(BS_Wvl2))./(CO_10_P_av(BS_Wvl1)+CO_10_P_av(BS_Wvl2));
INDEX1_COF_10_P = (COF_10_P_av(BS_Wvl1)-COF_10_P_av(BS_Wvl2))./(COF_10_P_av(BS_Wvl1)+COF_10_P_av(BS_Wvl2));
INDEX1_K_10_P = (K_10_P_av(BS_Wvl1)-K_10_P_av(BS_Wvl2))./(K_10_P_av(BS_Wvl1)+K_10_P_av(BS_Wvl2));
INDEX1_OJ_10_P = (OJ_10_P_av(BS_Wvl1)-OJ_10_P_av(BS_Wvl2))./(OJ_10_P_av(BS_Wvl1)+OJ_10_P_av(BS_Wvl2));
INDEX1_PD_10_P = (PD_10_P_av(BS_Wvl1)-PD_10_P_av(BS_Wvl2))./(PD_10_P_av(BS_Wvl1)+PD_10_P_av(BS_Wvl2));
INDEX1_RW_10_P = (RW_10_P_av(BS_Wvl1)-RW_10_P_av(BS_Wvl2))./(RW_10_P_av(BS_Wvl1)+RW_10_P_av(BS_Wvl2));
INDEX1_T_10_P = (T_10_P_av(BS_Wvl1)-T_10_P_av(BS_Wvl2))./(T_10_P_av(BS_Wvl1)+T_10_P_av(BS_Wvl2));
INDEX1_TS_10_P = (TS_10_P_av(BS_Wvl1)-TS_10_P_av(BS_Wvl2))./(TS_10_P_av(BS_Wvl1)+TS_10_P_av(BS_Wvl2));
%INDEX1_PETRI4 = [INDEX1_AVD4_P INDEX1_CS4_P INDEX1_C4_P INDEX1_K4_P INDEX1_OJ4_P INDEX1_PD4_P INDEX1_RW4_P INDEX1_T4_P INDEX1_TS4_P];



h(10)=scatter(11*ones(21,1), INDEX1_BLD_10_P, 'r', 'filled');

h(1) = plot(12*ones(21,1), INDEX1_AVD_10_P, '*');
h(2) = plot(13*ones(21,1), INDEX1_CO_10_P, '*');
h(3) = plot(14*ones(21,1), INDEX1_COF_10_P, '*');
h(4) = plot(15*ones(21,1), INDEX1_K_10_P, '*');
h(5) = plot(16*ones(21,1), INDEX1_OJ_10_P, '*');
h(6) = plot(17*ones(21,1), INDEX1_PD_10_P, '*');
h(7) = plot(18*ones(21,1), INDEX1_RW_10_P, '*');
h(8) = plot(19*ones(21,1), INDEX1_T_10_P, '*');
h(9) = plot(20*ones(21,1), INDEX1_TS_10_P, '*');
...
%%%%%%%%%%%%%%%%%%%     18ML Petri Dish    %%%%%%%%%%%%%%%%%%%%%
INDEX1_BLD_18_P = (blood_18_av(BS_Wvl1)-blood_18_av(BS_Wvl2))./(blood_18_av(BS_Wvl1)+blood_18_av(BS_Wvl2));
INDEX1_AVD_18_P = (AVD_18_P_av(BS_Wvl1)-AVD_18_P_av(BS_Wvl2))./(AVD_18_P_av(BS_Wvl1)+AVD_18_P_av(BS_Wvl2));
INDEX1_CO_18_P = (CO_18_P_av(BS_Wvl1)-CO_18_P_av(BS_Wvl2))./(CO_18_P_av(BS_Wvl1)+CO_18_P_av(BS_Wvl2));
INDEX1_COF_18_P = (COF_18_P_av(BS_Wvl1)-COF_18_P_av(BS_Wvl2))./(COF_18_P_av(BS_Wvl1)+COF_18_P_av(BS_Wvl2));
INDEX1_K_18_P = (K_18_P_av(BS_Wvl1)-K_18_P_av(BS_Wvl2))./(K_18_P_av(BS_Wvl1)+K_18_P_av(BS_Wvl2));
INDEX1_OJ_18_P = (OJ_18_P_av(BS_Wvl1)-OJ_18_P_av(BS_Wvl2))./(OJ_18_P_av(BS_Wvl1)+OJ_18_P_av(BS_Wvl2));
INDEX1_PD_18_P = (PD_18_P_av(BS_Wvl1)-PD_18_P_av(BS_Wvl2))./(PD_18_P_av(BS_Wvl1)+PD_18_P_av(BS_Wvl2));
INDEX1_RW_18_P = (RW_18_P_av(BS_Wvl1)-RW_18_P_av(BS_Wvl2))./(RW_18_P_av(BS_Wvl1)+RW_18_P_av(BS_Wvl2));
INDEX1_T_18_P = (T_18_P_av(BS_Wvl1)-T_18_P_av(BS_Wvl2))./(T_18_P_av(BS_Wvl1)+T_18_P_av(BS_Wvl2));
INDEX1_TS_18_P = (TS_18_P_av(BS_Wvl1)-TS_18_P_av(BS_Wvl2))./(TS_18_P_av(BS_Wvl1)+TS_18_P_av(BS_Wvl2));
...
scatter(21*ones(21,1), INDEX1_BLD_18_P, 'r', 'filled');

h(1) = plot(22*ones(21,1), INDEX1_AVD_18_P, '*');
h(2) = plot(23*ones(21,1), INDEX1_CO_18_P, '*');
h(3) = plot(24*ones(21,1), INDEX1_COF_18_P, '*');
h(4) = plot(25*ones(21,1), INDEX1_K_18_P, '*');
h(5) = plot(26*ones(21,1), INDEX1_OJ_18_P, '*');
h(6) = plot(27*ones(21,1), INDEX1_PD_18_P, '*');
h(7) = plot(28*ones(21,1), INDEX1_RW_18_P, '*');
h(8) = plot(29*ones(21,1), INDEX1_T_18_P, '*');
h(9) = plot(30*ones(21,1), INDEX1_TS_18_P, '*');
...
%%%%%%%%%%%%%%%%%%%     30ML Petri Dish    %%%%%%%%%%%%%%%%%%%%%
INDEX1_BLD_30_P = (blood_30_av(BS_Wvl1)-blood_30_av(BS_Wvl2))./(blood_30_av(BS_Wvl1)+blood_30_av(BS_Wvl2));
INDEX1_AVD_30_P = (AVD_30_P_av(BS_Wvl1)-AVD_30_P_av(BS_Wvl2))./(AVD_30_P_av(BS_Wvl1)+AVD_30_P_av(BS_Wvl2));
INDEX1_CO_30_P = (CO_30_P_av(BS_Wvl1)-CO_30_P_av(BS_Wvl2))./(CO_30_P_av(BS_Wvl1)+CO_30_P_av(BS_Wvl2));
INDEX1_COF_30_P = (COF_30_P_av(BS_Wvl1)-COF_30_P_av(BS_Wvl2))./(COF_30_P_av(BS_Wvl1)+COF_30_P_av(BS_Wvl2));
INDEX1_K_30_P = (K_30_P_av(BS_Wvl1)-K_30_P_av(BS_Wvl2))./(K_30_P_av(BS_Wvl1)+K_30_P_av(BS_Wvl2));
INDEX1_OJ_30_P = (OJ_30_P_av(BS_Wvl1)-OJ_30_P_av(BS_Wvl2))./(OJ_30_P_av(BS_Wvl1)+OJ_30_P_av(BS_Wvl2));
INDEX1_PD_30_P = (PD_30_P_av(BS_Wvl1)-PD_30_P_av(BS_Wvl2))./(PD_30_P_av(BS_Wvl1)+PD_30_P_av(BS_Wvl2));
INDEX1_RW_30_P = (RW_30_P_av(BS_Wvl1)-RW_30_P_av(BS_Wvl2))./(RW_30_P_av(BS_Wvl1)+RW_30_P_av(BS_Wvl2));
INDEX1_T_30_P = (T_30_P_av(BS_Wvl1)-T_30_P_av(BS_Wvl2))./(T_30_P_av(BS_Wvl1)+T_30_P_av(BS_Wvl2));
INDEX1_TS_30_P = (TS_30_P_av(BS_Wvl1)-TS_30_P_av(BS_Wvl2))./(TS_30_P_av(BS_Wvl1)+TS_30_P_av(BS_Wvl2));
...
scatter(31*ones(21,1), INDEX1_BLD_30_P, 'r', 'filled');


h(1) = plot(32*ones(21,1), INDEX1_AVD_30_P, '*');
h(2) = plot(33*ones(21,1), INDEX1_CO_30_P, '*');
h(3) = plot(34*ones(21,1), INDEX1_COF_30_P, '*');
h(4) = plot(35*ones(21,1), INDEX1_K_30_P, '*');
h(5) = plot(36*ones(21,1), INDEX1_OJ_30_P, '*');
h(6) = plot(37*ones(21,1), INDEX1_PD_30_P, '*');
h(7) = plot(38*ones(21,1), INDEX1_RW_30_P, '*');
h(8) = plot(39*ones(21,1), INDEX1_T_30_P, '*');
h(9) = plot(40*ones(21,1), INDEX1_TS_30_P, '*');
...
%%%%%%%%%%%%%%%%%%%     40ML Petri Dish    %%%%%%%%%%%%%%%%%%%%%
INDEX1_BLD_40_P = (blood_40_av(BS_Wvl1)-blood_40_av(BS_Wvl2))./(blood_40_av(BS_Wvl1)+blood_40_av(BS_Wvl2));
INDEX1_AVD_40_P = (AVD_40_P_av(BS_Wvl1)-AVD_40_P_av(BS_Wvl2))./(AVD_40_P_av(BS_Wvl1)+AVD_40_P_av(BS_Wvl2));
INDEX1_CO_40_P = (CO_40_P_av(BS_Wvl1)-CO_40_P_av(BS_Wvl2))./(CO_40_P_av(BS_Wvl1)+CO_40_P_av(BS_Wvl2));
INDEX1_COF_40_P = (COF_40_P_av(BS_Wvl1)-COF_40_P_av(BS_Wvl2))./(COF_40_P_av(BS_Wvl1)+COF_40_P_av(BS_Wvl2));
INDEX1_K_40_P = (K_40_P_av(BS_Wvl1)-K_40_P_av(BS_Wvl2))./(K_40_P_av(BS_Wvl1)+K_40_P_av(BS_Wvl2));
INDEX1_OJ_40_P = (OJ_40_P_av(BS_Wvl1)-OJ_40_P_av(BS_Wvl2))./(OJ_40_P_av(BS_Wvl1)+OJ_40_P_av(BS_Wvl2));
INDEX1_PD_40_P = (PD_40_P_av(BS_Wvl1)-PD_40_P_av(BS_Wvl2))./(PD_40_P_av(BS_Wvl1)+PD_40_P_av(BS_Wvl2));
INDEX1_RW_40_P = (RW_40_P_av(BS_Wvl1)-RW_40_P_av(BS_Wvl2))./(RW_40_P_av(BS_Wvl1)+RW_40_P_av(BS_Wvl2));
INDEX1_T_40_P = (T_40_P_av(BS_Wvl1)-T_40_P_av(BS_Wvl2))./(T_40_P_av(BS_Wvl1)+T_40_P_av(BS_Wvl2));
INDEX1_TS_40_P = (TS_40_P_av(BS_Wvl1)-TS_40_P_av(BS_Wvl2))./(TS_40_P_av(BS_Wvl1)+TS_40_P_av(BS_Wvl2));
...
scatter(41*ones(21,1), INDEX1_BLD_40_P, 'r', 'filled');

h(1) = plot(42*ones(21,1), INDEX1_AVD_40_P, '*');
h(2) = plot(43*ones(21,1), INDEX1_CO_40_P, '*');
h(3) = plot(44*ones(21,1), INDEX1_COF_40_P, '*');
h(4) = plot(45*ones(21,1), INDEX1_K_40_P, '*');
h(5) = plot(46*ones(21,1), INDEX1_OJ_40_P, '*');
h(6) = plot(47*ones(21,1), INDEX1_PD_40_P, '*');
h(7) = plot(48*ones(21,1), INDEX1_RW_40_P, '*');
h(8) = plot(49*ones(21,1), INDEX1_T_40_P, '*');
h(9) = plot(50*ones(21,1), INDEX1_TS_40_P, '*');
...
%%%%%%%%%%%%%%%%%   Black Felt   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_4_BLKF = (blood_4_BLKF(BS_Wvl1)-blood_4_BLKF(BS_Wvl2))./(blood_4_BLKF(BS_Wvl1)+blood_4_BLKF(BS_Wvl2));
INDEX1_AVD_4_BLKF = (AVD_4_BLKF(BS_Wvl1)-AVD_4_BLKF(BS_Wvl2))./(AVD_4_BLKF(BS_Wvl1)+AVD_4_BLKF(BS_Wvl2));
INDEX1_CO_4_BLKF = (CO_4_BLKF(BS_Wvl1)-CO_4_BLKF(BS_Wvl2))./(CO_4_BLKF(BS_Wvl1)+CO_4_BLKF(BS_Wvl2));
INDEX1_COF_4_BLKF = (COF_4_BLKF(BS_Wvl1)-COF_4_BLKF(BS_Wvl2))./(COF_4_BLKF(BS_Wvl1)+COF_4_BLKF(BS_Wvl2));
INDEX1_K_4_BLKF = (K_4_BLKF(BS_Wvl1)-K_4_BLKF(BS_Wvl2))./(K_4_BLKF(BS_Wvl1)+K_4_BLKF(BS_Wvl2));
INDEX1_OJ_4_BLKF = (OJ_4_BLKF(BS_Wvl1)-OJ_4_BLKF(BS_Wvl2))./(OJ_4_BLKF(BS_Wvl1)+OJ_4_BLKF(BS_Wvl2));
INDEX1_PD_4_BLKF = (PD_4_BLKF(BS_Wvl1)-PD_4_BLKF(BS_Wvl2))./(PD_4_BLKF(BS_Wvl1)+PD_4_BLKF(BS_Wvl2));
INDEX1_RW_4_BLKF = (RW_4_BLKF(BS_Wvl1)-RW_4_BLKF(BS_Wvl2))./(RW_4_BLKF(BS_Wvl1)+RW_4_BLKF(BS_Wvl2));
INDEX1_T_4_BLKF = (T_4_BLKF(BS_Wvl1)-T_4_BLKF(BS_Wvl2))./(T_4_BLKF(BS_Wvl1)+T_4_BLKF(BS_Wvl2));
INDEX1_TS_4_BLKF = (TS_4_BLKF(BS_Wvl1)-TS_4_BLKF(BS_Wvl2))./(TS_4_BLKF(BS_Wvl1)+TS_4_BLKF(BS_Wvl2));%INDEX1_TS2_BLKF = (TS2_BLKF(601)-TS2_BLKF(851))/(TS2_BLKF(601)+TS2_BLKF(851));
...
scatter(51*ones(21,1), INDEX1_blood_4_BLKF, 'r', 'filled');

h(1) = plot(52*ones(21,1), INDEX1_AVD_4_BLKF, '*');
h(2) = plot(53*ones(21,1), INDEX1_CO_4_BLKF, '*');
h(3) = plot(54*ones(21,1), INDEX1_COF_4_BLKF, '*');
h(4) = plot(55*ones(21,1), INDEX1_K_4_BLKF, '*');
h(5) = plot(56*ones(21,1), INDEX1_OJ_4_BLKF, '*');
h(6) = plot(57*ones(21,1), INDEX1_PD_4_BLKF, '*');
h(7) = plot(58*ones(21,1), INDEX1_RW_4_BLKF, '*');
h(8) = plot(59*ones(21,1), INDEX1_T_4_BLKF, '*');
h(9) = plot(60*ones(21,1), INDEX1_TS_4_BLKF, '*');
...
%}
%%%%%% 10ML %%
INDEX1_blood_10_BLKF = (blood_10_BLKF(BS_Wvl1)-blood_10_BLKF(BS_Wvl2))./(blood_10_BLKF(BS_Wvl1)+blood_10_BLKF(BS_Wvl2));
INDEX1_AVD_10_BLKF = (AVD_10_BLKF(BS_Wvl1)-AVD_10_BLKF(BS_Wvl2))./(AVD_10_BLKF(BS_Wvl1)+AVD_10_BLKF(BS_Wvl2));
INDEX1_CO_10_BLKF = (CO_10_BLKF(BS_Wvl1)-CO_10_BLKF(BS_Wvl2))./(CO_10_BLKF(BS_Wvl1)+CO_10_BLKF(BS_Wvl2));
INDEX1_COF_10_BLKF = (COF_10_BLKF(BS_Wvl1)-COF_10_BLKF(BS_Wvl2))./(COF_10_BLKF(BS_Wvl1)+COF_10_BLKF(BS_Wvl2));
INDEX1_K_10_BLKF = (K_10_BLKF(BS_Wvl1)-K_10_BLKF(BS_Wvl2))./(K_10_BLKF(BS_Wvl1)+K_10_BLKF(BS_Wvl2));
INDEX1_OJ_10_BLKF = (OJ_10_BLKF(BS_Wvl1)-OJ_10_BLKF(BS_Wvl2))./(OJ_10_BLKF(BS_Wvl1)+OJ_10_BLKF(BS_Wvl2));
INDEX1_PD_10_BLKF = (PD_10_BLKF(BS_Wvl1)-PD_10_BLKF(BS_Wvl2))./(PD_10_BLKF(BS_Wvl1)+PD_10_BLKF(BS_Wvl2));
INDEX1_RW_10_BLKF = (RW_10_BLKF(BS_Wvl1)-RW_10_BLKF(BS_Wvl2))./(RW_10_BLKF(BS_Wvl1)+RW_10_BLKF(BS_Wvl2));
INDEX1_T_10_BLKF = (T_10_BLKF(BS_Wvl1)-T_10_BLKF(BS_Wvl2))./(T_10_BLKF(BS_Wvl1)+T_10_BLKF(BS_Wvl2));
INDEX1_TS_10_BLKF = (TS_10_BLKF(BS_Wvl1)-TS_10_BLKF(BS_Wvl2))./(TS_10_BLKF(BS_Wvl1)+TS_10_BLKF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(61*ones(21,1), INDEX1_blood_10_BLKF, 'r', 'filled');

h(1) = plot(62*ones(21,1), INDEX1_AVD_10_BLKF, '*');
h(2) = plot(63*ones(21,1), INDEX1_CO_10_BLKF, '*');
h(3) = plot(64*ones(21,1), INDEX1_COF_10_BLKF, '*');
h(4) = plot(65*ones(21,1), INDEX1_K_10_BLKF, '*');
h(5) = plot(66*ones(21,1), INDEX1_OJ_10_BLKF, '*');
h(6) = plot(67*ones(21,1), INDEX1_PD_10_BLKF, '*');
h(7) = plot(68*ones(21,1), INDEX1_RW_10_BLKF, '*');
h(8) = plot(69*ones(21,1), INDEX1_T_10_BLKF, '*');
h(9) = plot(70*ones(21,1), INDEX1_TS_10_BLKF, '*');
...
%%%%%% 18ML %%
INDEX1_blood_18_BLKF = (blood_18_BLKF(BS_Wvl1)-blood_18_BLKF(BS_Wvl2))./(blood_18_BLKF(BS_Wvl1)+blood_18_BLKF(BS_Wvl2));
INDEX1_AVD_18_BLKF = (AVD_18_BLKF(BS_Wvl1)-AVD_18_BLKF(BS_Wvl2))./(AVD_18_BLKF(BS_Wvl1)+AVD_18_BLKF(BS_Wvl2));
INDEX1_CO_18_BLKF = (CO_18_BLKF(BS_Wvl1)-CO_18_BLKF(BS_Wvl2))./(CO_18_BLKF(BS_Wvl1)+CO_18_BLKF(BS_Wvl2));
INDEX1_COF_18_BLKF = (COF_18_BLKF(BS_Wvl1)-COF_18_BLKF(BS_Wvl2))./(COF_18_BLKF(BS_Wvl1)+COF_18_BLKF(BS_Wvl2));
INDEX1_K_18_BLKF = (K_18_BLKF(BS_Wvl1)-K_18_BLKF(BS_Wvl2))./(K_18_BLKF(BS_Wvl1)+K_18_BLKF(BS_Wvl2));
INDEX1_OJ_18_BLKF = (OJ_18_BLKF(BS_Wvl1)-OJ_18_BLKF(BS_Wvl2))./(OJ_18_BLKF(BS_Wvl1)+OJ_18_BLKF(BS_Wvl2));
INDEX1_PD_18_BLKF = (PD_18_BLKF(BS_Wvl1)-PD_18_BLKF(BS_Wvl2))./(PD_18_BLKF(BS_Wvl1)+PD_18_BLKF(BS_Wvl2));
INDEX1_RW_18_BLKF = (RW_18_BLKF(BS_Wvl1)-RW_18_BLKF(BS_Wvl2))./(RW_18_BLKF(BS_Wvl1)+RW_18_BLKF(BS_Wvl2));
INDEX1_T_18_BLKF = (T_18_BLKF(BS_Wvl1)-T_18_BLKF(BS_Wvl2))./(T_18_BLKF(BS_Wvl1)+T_18_BLKF(BS_Wvl2));
INDEX1_TS_18_BLKF = (TS_18_BLKF(BS_Wvl1)-TS_18_BLKF(BS_Wvl2))./(TS_18_BLKF(BS_Wvl1)+TS_18_BLKF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(71*ones(21,1), INDEX1_blood_18_BLKF, 'r', 'filled');

h(1) = plot(72*ones(21,1), INDEX1_AVD_18_BLKF, '*');
h(2) = plot(73*ones(21,1), INDEX1_CO_18_BLKF, '*');
h(3) = plot(74*ones(21,1), INDEX1_COF_18_BLKF, '*');
h(4) = plot(75*ones(21,1), INDEX1_K_18_BLKF, '*');
h(5) = plot(76*ones(21,1), INDEX1_OJ_18_BLKF, '*');
h(6) = plot(77*ones(21,1), INDEX1_PD_18_BLKF, '*');
h(7) = plot(78*ones(21,1), INDEX1_RW_18_BLKF, '*');
h(8) = plot(79*ones(21,1), INDEX1_T_18_BLKF, '*');
h(9) = plot(80*ones(21,1), INDEX1_TS_18_BLKF, '*');
...
%%%%%% 30ML %%
INDEX1_blood_30_BLKF = (blood_30_BLKF(BS_Wvl1)-blood_30_BLKF(BS_Wvl2))./(blood_30_BLKF(BS_Wvl1)+blood_30_BLKF(BS_Wvl2));
INDEX1_AVD_30_BLKF = (AVD_30_BLKF(BS_Wvl1)-AVD_30_BLKF(BS_Wvl2))./(AVD_30_BLKF(BS_Wvl1)+AVD_30_BLKF(BS_Wvl2));
INDEX1_CO_30_BLKF = (CO_30_BLKF(BS_Wvl1)-CO_30_BLKF(BS_Wvl2))./(CO_30_BLKF(BS_Wvl1)+CO_30_BLKF(BS_Wvl2));
INDEX1_COF_30_BLKF = (COF_30_BLKF(BS_Wvl1)-COF_30_BLKF(BS_Wvl2))./(COF_30_BLKF(BS_Wvl1)+COF_30_BLKF(BS_Wvl2));
INDEX1_K_30_BLKF = (K_30_BLKF(BS_Wvl1)-K_30_BLKF(BS_Wvl2))./(K_30_BLKF(BS_Wvl1)+K_30_BLKF(BS_Wvl2));
INDEX1_OJ_30_BLKF = (OJ_30_BLKF(BS_Wvl1)-OJ_30_BLKF(BS_Wvl2))./(OJ_30_BLKF(BS_Wvl1)+OJ_30_BLKF(BS_Wvl2));
INDEX1_PD_30_BLKF = (PD_30_BLKF(BS_Wvl1)-PD_30_BLKF(BS_Wvl2))./(PD_30_BLKF(BS_Wvl1)+PD_30_BLKF(BS_Wvl2));
INDEX1_RW_30_BLKF = (RW_30_BLKF(BS_Wvl1)-RW_30_BLKF(BS_Wvl2))./(RW_30_BLKF(BS_Wvl1)+RW_30_BLKF(BS_Wvl2));
INDEX1_T_30_BLKF = (T_30_BLKF(BS_Wvl1)-T_30_BLKF(BS_Wvl2))./(T_30_BLKF(BS_Wvl1)+T_30_BLKF(BS_Wvl2));
INDEX1_TS_30_BLKF = (TS_30_BLKF(BS_Wvl1)-TS_30_BLKF(BS_Wvl2))./(TS_30_BLKF(BS_Wvl1)+TS_30_BLKF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(81*ones(21,1), INDEX1_blood_30_BLKF, 'r', 'filled');

h(1) = plot(82*ones(21,1), INDEX1_AVD_30_BLKF, '*');
h(2) = plot(83*ones(21,1), INDEX1_CO_30_BLKF, '*');
h(3) = plot(84*ones(21,1), INDEX1_COF_30_BLKF, '*');
h(4) = plot(85*ones(21,1), INDEX1_K_30_BLKF, '*');
h(5) = plot(86*ones(21,1), INDEX1_OJ_30_BLKF, '*');
h(6) = plot(87*ones(21,1), INDEX1_PD_30_BLKF, '*');
h(7) = plot(88*ones(21,1), INDEX1_RW_30_BLKF, '*');
h(8) = plot(89*ones(21,1), INDEX1_T_30_BLKF, '*');
h(9) = plot(90*ones(21,1), INDEX1_TS_30_BLKF, '*');
...
%%%%%% 40ML %%
INDEX1_blood_40_BLKF = (blood_40_BLKF(BS_Wvl1)-blood_40_BLKF(BS_Wvl2))./(blood_40_BLKF(BS_Wvl1)+blood_40_BLKF(BS_Wvl2));
INDEX1_AVD_40_BLKF = (AVD_40_BLKF(BS_Wvl1)-AVD_40_BLKF(BS_Wvl2))./(AVD_40_BLKF(BS_Wvl1)+AVD_40_BLKF(BS_Wvl2));
INDEX1_CO_40_BLKF = (CO_40_BLKF(BS_Wvl1)-CO_40_BLKF(BS_Wvl2))./(CO_40_BLKF(BS_Wvl1)+CO_40_BLKF(BS_Wvl2));
INDEX1_COF_40_BLKF = (COF_40_BLKF(BS_Wvl1)-COF_40_BLKF(BS_Wvl2))./(COF_40_BLKF(BS_Wvl1)+COF_40_BLKF(BS_Wvl2));
INDEX1_K_40_BLKF = (K_40_BLKF(BS_Wvl1)-K_40_BLKF(BS_Wvl2))./(K_40_BLKF(BS_Wvl1)+K_40_BLKF(BS_Wvl2));
INDEX1_OJ_40_BLKF = (OJ_40_BLKF(BS_Wvl1)-OJ_40_BLKF(BS_Wvl2))./(OJ_40_BLKF(BS_Wvl1)+OJ_40_BLKF(BS_Wvl2));
INDEX1_PD_40_BLKF = (PD_40_BLKF(BS_Wvl1)-PD_40_BLKF(BS_Wvl2))./(PD_40_BLKF(BS_Wvl1)+PD_40_BLKF(BS_Wvl2));
INDEX1_RW_40_BLKF = (RW_40_BLKF(BS_Wvl1)-RW_40_BLKF(BS_Wvl2))./(RW_40_BLKF(BS_Wvl1)+RW_40_BLKF(BS_Wvl2));
INDEX1_T_40_BLKF = (T_40_BLKF(BS_Wvl1)-T_40_BLKF(BS_Wvl2))./(T_40_BLKF(BS_Wvl1)+T_40_BLKF(BS_Wvl2));
INDEX1_TS_40_BLKF = (TS_40_BLKF(BS_Wvl1)-TS_40_BLKF(BS_Wvl2))./(TS_40_BLKF(BS_Wvl1)+TS_40_BLKF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(91*ones(21,1), INDEX1_blood_40_BLKF, 'r', 'filled');

h(1) = plot(92*ones(21,1), INDEX1_AVD_40_BLKF, '*');
h(2) = plot(93*ones(21,1), INDEX1_CO_40_BLKF, '*');
h(3) = plot(94*ones(21,1), INDEX1_COF_40_BLKF, '*');
h(4) = plot(95*ones(21,1), INDEX1_K_40_BLKF, '*');
h(5) = plot(96*ones(21,1), INDEX1_OJ_40_BLKF, '*');
h(6) = plot(97*ones(21,1), INDEX1_PD_40_BLKF, '*');
h(7) = plot(98*ones(21,1), INDEX1_RW_40_BLKF, '*');
h(8) = plot(99*ones(21,1), INDEX1_T_40_BLKF, '*');
h(9) = plot(100*ones(21,1), INDEX1_TS_40_BLKF, '*');
...
%%%%%%%%%%%%%%%%%   GREY Felt   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_4_GRYF = (blood_4_GRYF(BS_Wvl1)-blood_4_GRYF(BS_Wvl2))./(blood_4_GRYF(BS_Wvl1)+blood_4_GRYF(BS_Wvl2));
INDEX1_AVD_4_GRYF = (AVD_4_GRYF(BS_Wvl1)-AVD_4_GRYF(BS_Wvl2))./(AVD_4_GRYF(BS_Wvl1)+AVD_4_GRYF(BS_Wvl2));
INDEX1_CO_4_GRYF = (CO_4_GRYF(BS_Wvl1)-CO_4_GRYF(BS_Wvl2))./(CO_4_GRYF(BS_Wvl1)+CO_4_GRYF(BS_Wvl2));
INDEX1_COF_4_GRYF = (COF_4_GRYF(BS_Wvl1)-COF_4_GRYF(BS_Wvl2))./(COF_4_GRYF(BS_Wvl1)+COF_4_GRYF(BS_Wvl2));
INDEX1_K_4_GRYF = (K_4_GRYF(BS_Wvl1)-K_4_GRYF(BS_Wvl2))./(K_4_GRYF(BS_Wvl1)+K_4_GRYF(BS_Wvl2));
INDEX1_OJ_4_GRYF = (OJ_4_GRYF(BS_Wvl1)-OJ_4_GRYF(BS_Wvl2))./(OJ_4_GRYF(BS_Wvl1)+OJ_4_GRYF(BS_Wvl2));
INDEX1_PD_4_GRYF = (PD_4_GRYF(BS_Wvl1)-PD_4_GRYF(BS_Wvl2))./(PD_4_GRYF(BS_Wvl1)+PD_4_GRYF(BS_Wvl2));
INDEX1_RW_4_GRYF = (RW_4_GRYF(BS_Wvl1)-RW_4_GRYF(BS_Wvl2))./(RW_4_GRYF(BS_Wvl1)+RW_4_GRYF(BS_Wvl2));
INDEX1_T_4_GRYF = (T_4_GRYF(BS_Wvl1)-T_4_GRYF(BS_Wvl2))./(T_4_GRYF(BS_Wvl1)+T_4_GRYF(BS_Wvl2));
INDEX1_TS_4_GRYF = (TS_4_GRYF(BS_Wvl1)-TS_4_GRYF(BS_Wvl2))./(TS_4_GRYF(BS_Wvl1)+TS_4_GRYF(BS_Wvl2)); %INDEX1_TS2_GRYF = (TS2_GRYF(601)-TS2_GRYF(851))/(TS2_GRYF(601)+TS2_GRYF(851));
...
scatter(101*ones(21,1), INDEX1_blood_4_GRYF, 'r', 'filled');

h(1) = plot(102*ones(21,1), INDEX1_AVD_4_GRYF, '*');
h(2) = plot(103*ones(21,1), INDEX1_CO_4_GRYF, '*');
h(3) = plot(104*ones(21,1), INDEX1_COF_4_GRYF, '*');
h(4) = plot(105*ones(21,1), INDEX1_K_4_GRYF, '*');
h(5) = plot(106*ones(21,1), INDEX1_OJ_4_GRYF, '*');
h(6) = plot(107*ones(21,1), INDEX1_PD_4_GRYF, '*');
h(7) = plot(108*ones(21,1), INDEX1_RW_4_GRYF, '*');
h(8) = plot(109*ones(21,1), INDEX1_T_4_GRYF, '*');
h(9) = plot(110*ones(21,1), INDEX1_TS_4_GRYF, '*');
...
%%%%%% 10ML %%
INDEX1_blood_10_GRYF = (blood_10_GRYF(BS_Wvl1)-blood_10_GRYF(BS_Wvl2))./(blood_10_GRYF(BS_Wvl1)+blood_10_GRYF(BS_Wvl2));
INDEX1_AVD_10_GRYF = (AVD_10_GRYF(BS_Wvl1)-AVD_10_GRYF(BS_Wvl2))./(AVD_10_GRYF(BS_Wvl1)+AVD_10_GRYF(BS_Wvl2));
INDEX1_CO_10_GRYF = (CO_10_GRYF(BS_Wvl1)-CO_10_GRYF(BS_Wvl2))./(CO_10_GRYF(BS_Wvl1)+CO_10_GRYF(BS_Wvl2));
INDEX1_COF_10_GRYF = (COF_10_GRYF(BS_Wvl1)-COF_10_GRYF(BS_Wvl2))./(COF_10_GRYF(BS_Wvl1)+COF_10_GRYF(BS_Wvl2));
INDEX1_K_10_GRYF = (K_10_GRYF(BS_Wvl1)-K_10_GRYF(BS_Wvl2))./(K_10_GRYF(BS_Wvl1)+K_10_GRYF(BS_Wvl2));
INDEX1_OJ_10_GRYF = (OJ_10_GRYF(BS_Wvl1)-OJ_10_GRYF(BS_Wvl2))./(OJ_10_GRYF(BS_Wvl1)+OJ_10_GRYF(BS_Wvl2));
INDEX1_PD_10_GRYF = (PD_10_GRYF(BS_Wvl1)-PD_10_GRYF(BS_Wvl2))./(PD_10_GRYF(BS_Wvl1)+PD_10_GRYF(BS_Wvl2));
INDEX1_RW_10_GRYF = (RW_10_GRYF(BS_Wvl1)-RW_10_GRYF(BS_Wvl2))./(RW_10_GRYF(BS_Wvl1)+RW_10_GRYF(BS_Wvl2));
INDEX1_T_10_GRYF = (T_10_GRYF(BS_Wvl1)-T_10_GRYF(BS_Wvl2))./(T_10_GRYF(BS_Wvl1)+T_10_GRYF(BS_Wvl2));
INDEX1_TS_10_GRYF = (TS_10_GRYF(BS_Wvl1)-TS_10_GRYF(BS_Wvl2))./(TS_10_GRYF(BS_Wvl1)+TS_10_GRYF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(111*ones(21,1), INDEX1_blood_10_GRYF, 'r', 'filled');

h(1) = plot(112*ones(21,1), INDEX1_AVD_10_GRYF, '*');
h(2) = plot(113*ones(21,1), INDEX1_CO_10_GRYF, '*');
h(3) = plot(114*ones(21,1), INDEX1_COF_10_GRYF, '*');
h(4) = plot(115*ones(21,1), INDEX1_K_10_GRYF, '*');
h(5) = plot(116*ones(21,1), INDEX1_OJ_10_GRYF, '*');
h(6) = plot(117*ones(21,1), INDEX1_PD_10_GRYF, '*');
h(7) = plot(118*ones(21,1), INDEX1_RW_10_GRYF, '*');
h(8) = plot(119*ones(21,1), INDEX1_T_10_GRYF, '*');
h(9) = plot(120*ones(21,1), INDEX1_TS_10_GRYF, '*');
...
%%%%%% 18ML %%
INDEX1_blood_18_GRYF = (blood_18_GRYF(BS_Wvl1)-blood_18_GRYF(BS_Wvl2))./(blood_18_GRYF(BS_Wvl1)+blood_18_GRYF(BS_Wvl2));
INDEX1_AVD_18_GRYF = (AVD_18_GRYF(BS_Wvl1)-AVD_18_GRYF(BS_Wvl2))./(AVD_18_GRYF(BS_Wvl1)+AVD_18_GRYF(BS_Wvl2));
INDEX1_CO_18_GRYF = (CO_18_GRYF(BS_Wvl1)-CO_18_GRYF(BS_Wvl2))./(CO_18_GRYF(BS_Wvl1)+CO_18_GRYF(BS_Wvl2));
INDEX1_COF_18_GRYF = (COF_18_GRYF(BS_Wvl1)-COF_18_GRYF(BS_Wvl2))./(COF_18_GRYF(BS_Wvl1)+COF_18_GRYF(BS_Wvl2));
INDEX1_K_18_GRYF = (K_18_GRYF(BS_Wvl1)-K_18_GRYF(BS_Wvl2))./(K_18_GRYF(BS_Wvl1)+K_18_GRYF(BS_Wvl2));
INDEX1_OJ_18_GRYF = (OJ_18_GRYF(BS_Wvl1)-OJ_18_GRYF(BS_Wvl2))./(OJ_18_GRYF(BS_Wvl1)+OJ_18_GRYF(BS_Wvl2));
INDEX1_PD_18_GRYF = (PD_18_GRYF(BS_Wvl1)-PD_18_GRYF(BS_Wvl2))./(PD_18_GRYF(BS_Wvl1)+PD_18_GRYF(BS_Wvl2));
INDEX1_RW_18_GRYF = (RW_18_GRYF(BS_Wvl1)-RW_18_GRYF(BS_Wvl2))./(RW_18_GRYF(BS_Wvl1)+RW_18_GRYF(BS_Wvl2));
INDEX1_T_18_GRYF = (T_18_GRYF(BS_Wvl1)-T_18_GRYF(BS_Wvl2))./(T_18_GRYF(BS_Wvl1)+T_18_GRYF(BS_Wvl2));
INDEX1_TS_18_GRYF = (TS_18_GRYF(BS_Wvl1)-TS_18_GRYF(BS_Wvl2))./(TS_18_GRYF(BS_Wvl1)+TS_18_GRYF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(121*ones(21,1), INDEX1_blood_18_GRYF, 'r', 'filled');

h(1) = plot(122*ones(21,1), INDEX1_AVD_18_GRYF, '*');
h(2) = plot(123*ones(21,1), INDEX1_CO_18_GRYF, '*');
h(3) = plot(124*ones(21,1), INDEX1_COF_18_GRYF, '*');
h(4) = plot(125*ones(21,1), INDEX1_K_18_GRYF, '*');
h(5) = plot(126*ones(21,1), INDEX1_OJ_18_GRYF, '*');
h(6) = plot(127*ones(21,1), INDEX1_PD_18_GRYF, '*');
h(7) = plot(128*ones(21,1), INDEX1_RW_18_GRYF, '*');
h(8) = plot(129*ones(21,1), INDEX1_T_18_GRYF, '*');
h(9) = plot(130*ones(21,1), INDEX1_TS_18_GRYF, '*');
...
%%%%%% 30ML %%
INDEX1_blood_30_GRYF = (blood_30_GRYF(BS_Wvl1)-blood_30_GRYF(BS_Wvl2))./(blood_30_GRYF(BS_Wvl1)+blood_30_GRYF(BS_Wvl2));
INDEX1_AVD_30_GRYF = (AVD_30_GRYF(BS_Wvl1)-AVD_30_GRYF(BS_Wvl2))./(AVD_30_GRYF(BS_Wvl1)+AVD_30_GRYF(BS_Wvl2));
INDEX1_CO_30_GRYF = (CO_30_GRYF(BS_Wvl1)-CO_30_GRYF(BS_Wvl2))./(CO_30_GRYF(BS_Wvl1)+CO_30_GRYF(BS_Wvl2));
INDEX1_COF_30_GRYF = (COF_30_GRYF(BS_Wvl1)-COF_30_GRYF(BS_Wvl2))./(COF_30_GRYF(BS_Wvl1)+COF_30_GRYF(BS_Wvl2));
INDEX1_K_30_GRYF = (K_30_GRYF(BS_Wvl1)-K_30_GRYF(BS_Wvl2))./(K_30_GRYF(BS_Wvl1)+K_30_GRYF(BS_Wvl2));
INDEX1_OJ_30_GRYF = (OJ_30_GRYF(BS_Wvl1)-OJ_30_GRYF(BS_Wvl2))./(OJ_30_GRYF(BS_Wvl1)+OJ_30_GRYF(BS_Wvl2));
INDEX1_PD_30_GRYF = (PD_30_GRYF(BS_Wvl1)-PD_30_GRYF(BS_Wvl2))./(PD_30_GRYF(BS_Wvl1)+PD_30_GRYF(BS_Wvl2));
INDEX1_RW_30_GRYF = (RW_30_GRYF(BS_Wvl1)-RW_30_GRYF(BS_Wvl2))./(RW_30_GRYF(BS_Wvl1)+RW_30_GRYF(BS_Wvl2));
INDEX1_T_30_GRYF = (T_30_GRYF(BS_Wvl1)-T_30_GRYF(BS_Wvl2))./(T_30_GRYF(BS_Wvl1)+T_30_GRYF(BS_Wvl2));
INDEX1_TS_30_GRYF = (TS_30_GRYF(BS_Wvl1)-TS_30_GRYF(BS_Wvl2))./(TS_30_GRYF(BS_Wvl1)+TS_30_GRYF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(131*ones(21,1), INDEX1_blood_30_GRYF, 'r', 'filled');

h(1) = plot(132*ones(21,1), INDEX1_AVD_30_GRYF, '*');
h(2) = plot(133*ones(21,1), INDEX1_CO_30_GRYF, '*');
h(3) = plot(134*ones(21,1), INDEX1_COF_30_GRYF, '*');
h(4) = plot(135*ones(21,1), INDEX1_K_30_GRYF, '*');
h(5) = plot(136*ones(21,1), INDEX1_OJ_30_GRYF, '*');
h(6) = plot(137*ones(21,1), INDEX1_PD_30_GRYF, '*');
h(7) = plot(138*ones(21,1), INDEX1_RW_30_GRYF, '*');
h(8) = plot(139*ones(21,1), INDEX1_T_30_GRYF, '*');
h(9) = plot(140*ones(21,1), INDEX1_TS_30_GRYF, '*');
...
%%%%%% 40ML %%
INDEX1_blood_40_GRYF = (blood_40_GRYF(BS_Wvl1)-blood_40_GRYF(BS_Wvl2))./(blood_40_GRYF(BS_Wvl1)+blood_40_GRYF(BS_Wvl2));
INDEX1_AVD_40_GRYF = (AVD_40_GRYF(BS_Wvl1)-AVD_40_GRYF(BS_Wvl2))./(AVD_40_GRYF(BS_Wvl1)+AVD_40_GRYF(BS_Wvl2));
INDEX1_CO_40_GRYF = (CO_40_GRYF(BS_Wvl1)-CO_40_GRYF(BS_Wvl2))./(CO_40_GRYF(BS_Wvl1)+CO_40_GRYF(BS_Wvl2));
INDEX1_COF_40_GRYF = (COF_40_GRYF(BS_Wvl1)-COF_40_GRYF(BS_Wvl2))./(COF_40_GRYF(BS_Wvl1)+COF_40_GRYF(BS_Wvl2));
INDEX1_K_40_GRYF = (K_40_GRYF(BS_Wvl1)-K_40_GRYF(BS_Wvl2))./(K_40_GRYF(BS_Wvl1)+K_40_GRYF(BS_Wvl2));
INDEX1_OJ_40_GRYF = (OJ_40_GRYF(BS_Wvl1)-OJ_40_GRYF(BS_Wvl2))./(OJ_40_GRYF(BS_Wvl1)+OJ_40_GRYF(BS_Wvl2));
INDEX1_PD_40_GRYF = (PD_40_GRYF(BS_Wvl1)-PD_40_GRYF(BS_Wvl2))./(PD_40_GRYF(BS_Wvl1)+PD_40_GRYF(BS_Wvl2));
INDEX1_RW_40_GRYF = (RW_40_GRYF(BS_Wvl1)-RW_40_GRYF(BS_Wvl2))./(RW_40_GRYF(BS_Wvl1)+RW_40_GRYF(BS_Wvl2));
INDEX1_T_40_GRYF = (T_40_GRYF(BS_Wvl1)-T_40_GRYF(BS_Wvl2))./(T_40_GRYF(BS_Wvl1)+T_40_GRYF(BS_Wvl2));
INDEX1_TS_40_GRYF = (TS_40_GRYF(BS_Wvl1)-TS_40_GRYF(BS_Wvl2))./(TS_40_GRYF(BS_Wvl1)+TS_40_GRYF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(141*ones(21,1), INDEX1_blood_40_GRYF, 'r', 'filled');

h(1) = plot(142*ones(21,1), INDEX1_AVD_40_GRYF, '*');
h(2) = plot(143*ones(21,1), INDEX1_CO_40_GRYF, '*');
h(3) = plot(144*ones(21,1), INDEX1_COF_40_GRYF, '*');
h(4) = plot(145*ones(21,1), INDEX1_K_40_GRYF, '*');
h(5) = plot(146*ones(21,1), INDEX1_OJ_40_GRYF, '*');
h(6) = plot(147*ones(21,1), INDEX1_PD_40_GRYF, '*');
h(7) = plot(148*ones(21,1), INDEX1_RW_40_GRYF, '*');
h(8) = plot(149*ones(21,1), INDEX1_T_40_GRYF, '*');
h(9) = plot(150*ones(21,1), INDEX1_TS_40_GRYF, '*');
...
%{
%%%%%%%%%%%%%%%%%   GREEN Felt   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_4_GRNF = (blood_4_GRNF(BS_Wvl1)-blood_4_GRNF(BS_Wvl2))./(blood_4_GRNF(BS_Wvl1)+blood_4_GRNF(BS_Wvl2));
INDEX1_AVD_4_GRNF = (AVD_4_GRNF(BS_Wvl1)-AVD_4_GRNF(BS_Wvl2))./(AVD_4_GRNF(BS_Wvl1)+AVD_4_GRNF(BS_Wvl2));
INDEX1_CO_4_GRNF = (CO_4_GRNF(BS_Wvl1)-CO_4_GRNF(BS_Wvl2))./(CO_4_GRNF(BS_Wvl1)+CO_4_GRNF(BS_Wvl2));
INDEX1_COF_4_GRNF = (COF_4_GRNF(BS_Wvl1)-COF_4_GRNF(BS_Wvl2))./(COF_4_GRNF(BS_Wvl1)+COF_4_GRNF(BS_Wvl2));
INDEX1_K_4_GRNF = (K_4_GRNF(BS_Wvl1)-K_4_GRNF(BS_Wvl2))./(K_4_GRNF(BS_Wvl1)+K_4_GRNF(BS_Wvl2));
INDEX1_OJ_4_GRNF = (OJ_4_GRNF(BS_Wvl1)-OJ_4_GRNF(BS_Wvl2))./(OJ_4_GRNF(BS_Wvl1)+OJ_4_GRNF(BS_Wvl2));
INDEX1_PD_4_GRNF = (PD_4_GRNF(BS_Wvl1)-PD_4_GRNF(BS_Wvl2))./(PD_4_GRNF(BS_Wvl1)+PD_4_GRNF(BS_Wvl2));
INDEX1_RW_4_GRNF = (RW_4_GRNF(BS_Wvl1)-RW_4_GRNF(BS_Wvl2))./(RW_4_GRNF(BS_Wvl1)+RW_4_GRNF(BS_Wvl2));
INDEX1_T_4_GRNF = (T_4_GRNF(BS_Wvl1)-T_4_GRNF(BS_Wvl2))./(T_4_GRNF(BS_Wvl1)+T_4_GRNF(BS_Wvl2));
INDEX1_TS_4_GRNF = (TS_4_GRNF(BS_Wvl1)-TS_4_GRNF(BS_Wvl2))./(TS_4_GRNF(BS_Wvl1)+TS_4_GRNF(BS_Wvl2));%INDEX1_TS2_GRYF = (TS2_GRYF(601)-TS2_GRYF(851))/(TS2_GRYF(601)+TS2_GRYF(851));
...
%scatter(151*ones(21,1), INDEX1_blood_4_GRNF, 'r', 'filled');



h(1) = plot(152*ones(21,1), INDEX1_AVD_4_GRNF, '*');
h(2) = plot(153*ones(21,1), INDEX1_CO_4_GRNF, '*');
h(3) = plot(154*ones(21,1), INDEX1_COF_4_GRNF, '*');
h(4) = plot(155*ones(21,1), INDEX1_K_4_GRNF, '*');
h(5) = plot(156*ones(21,1), INDEX1_OJ_4_GRNF, '*');
h(6) = plot(157*ones(21,1), INDEX1_PD_4_GRNF, '*');
h(7) = plot(158*ones(21,1), INDEX1_RW_4_GRNF, '*');
h(8) = plot(159*ones(21,1), INDEX1_T_4_GRNF, '*');
h(9) = plot(160*ones(21,1), INDEX1_TS_4_GRNF, '*');
...
%%%%%% 10ML %%
INDEX1_blood_10_GRNF = (blood_10_GRNF(BS_Wvl1)-blood_10_GRNF(BS_Wvl2))./(blood_10_GRNF(BS_Wvl1)+blood_10_GRNF(BS_Wvl2));
INDEX1_AVD_10_GRNF = (AVD_10_GRNF(BS_Wvl1)-AVD_10_GRNF(BS_Wvl2))./(AVD_10_GRNF(BS_Wvl1)+AVD_10_GRNF(BS_Wvl2));
INDEX1_CO_10_GRNF = (CO_10_GRNF(BS_Wvl1)-CO_10_GRNF(BS_Wvl2))./(CO_10_GRNF(BS_Wvl1)+CO_10_GRNF(BS_Wvl2));
INDEX1_COF_10_GRNF = (COF_10_GRNF(BS_Wvl1)-COF_10_GRNF(BS_Wvl2))./(COF_10_GRNF(BS_Wvl1)+COF_10_GRNF(BS_Wvl2));
INDEX1_K_10_GRNF = (K_10_GRNF(BS_Wvl1)-K_10_GRNF(BS_Wvl2))./(K_10_GRNF(BS_Wvl1)+K_10_GRNF(BS_Wvl2));
INDEX1_OJ_10_GRNF = (OJ_10_GRNF(BS_Wvl1)-OJ_10_GRNF(BS_Wvl2))./(OJ_10_GRNF(BS_Wvl1)+OJ_10_GRNF(BS_Wvl2));
INDEX1_PD_10_GRNF = (PD_10_GRNF(BS_Wvl1)-PD_10_GRNF(BS_Wvl2))./(PD_10_GRNF(BS_Wvl1)+PD_10_GRNF(BS_Wvl2));
INDEX1_RW_10_GRNF = (RW_10_GRNF(BS_Wvl1)-RW_10_GRNF(BS_Wvl2))./(RW_10_GRNF(BS_Wvl1)+RW_10_GRNF(BS_Wvl2));
INDEX1_T_10_GRNF = (T_10_GRNF(BS_Wvl1)-T_10_GRNF(BS_Wvl2))./(T_10_GRNF(BS_Wvl1)+T_10_GRNF(BS_Wvl2));
INDEX1_TS_10_GRNF = (TS_10_GRNF(BS_Wvl1)-TS_10_GRNF(BS_Wvl2))./(TS_10_GRNF(BS_Wvl1)+TS_10_GRNF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(161*ones(21,1), INDEX1_blood_10_GRNF, 'r', 'filled');

h(1) = plot(162*ones(21,1), INDEX1_AVD_10_GRNF, '*');
h(2) = plot(163*ones(21,1), INDEX1_CO_10_GRNF, '*');
h(3) = plot(164*ones(21,1), INDEX1_COF_10_GRNF, '*');
h(4) = plot(165*ones(21,1), INDEX1_K_10_GRNF, '*');
h(5) = plot(166*ones(21,1), INDEX1_OJ_10_GRNF, '*');
h(6) = plot(167*ones(21,1), INDEX1_PD_10_GRNF, '*');
h(7) = plot(168*ones(21,1), INDEX1_RW_10_GRNF, '*');
h(8) = plot(169*ones(21,1), INDEX1_T_10_GRNF, '*');
h(9) = plot(170*ones(21,1), INDEX1_TS_10_GRNF, '*');
...
%%%%%% 18ML %%
INDEX1_blood_18_GRNF = (blood_18_GRNF(BS_Wvl1)-blood_18_GRNF(BS_Wvl2))./(blood_18_GRNF(BS_Wvl1)+blood_18_GRNF(BS_Wvl2));
INDEX1_AVD_18_GRNF = (AVD_18_GRNF(BS_Wvl1)-AVD_18_GRNF(BS_Wvl2))./(AVD_18_GRNF(BS_Wvl1)+AVD_18_GRNF(BS_Wvl2));
INDEX1_CO_18_GRNF = (CO_18_GRNF(BS_Wvl1)-CO_18_GRNF(BS_Wvl2))./(CO_18_GRNF(BS_Wvl1)+CO_18_GRNF(BS_Wvl2));
INDEX1_COF_18_GRNF = (COF_18_GRNF(BS_Wvl1)-COF_18_GRNF(BS_Wvl2))./(COF_18_GRNF(BS_Wvl1)+COF_18_GRNF(BS_Wvl2));
INDEX1_K_18_GRNF = (K_18_GRNF(BS_Wvl1)-K_18_GRNF(BS_Wvl2))./(K_18_GRNF(BS_Wvl1)+K_18_GRNF(BS_Wvl2));
INDEX1_OJ_18_GRNF = (OJ_18_GRNF(BS_Wvl1)-OJ_18_GRNF(BS_Wvl2))./(OJ_18_GRNF(BS_Wvl1)+OJ_18_GRNF(BS_Wvl2));
INDEX1_PD_18_GRNF = (PD_18_GRNF(BS_Wvl1)-PD_18_GRNF(BS_Wvl2))./(PD_18_GRNF(BS_Wvl1)+PD_18_GRNF(BS_Wvl2));
INDEX1_RW_18_GRNF = (RW_18_GRNF(BS_Wvl1)-RW_18_GRNF(BS_Wvl2))./(RW_18_GRNF(BS_Wvl1)+RW_18_GRNF(BS_Wvl2));
INDEX1_T_18_GRNF = (T_18_GRNF(BS_Wvl1)-T_18_GRNF(BS_Wvl2))./(T_18_GRNF(BS_Wvl1)+T_18_GRNF(BS_Wvl2));
INDEX1_TS_18_GRNF = (TS_18_GRNF(BS_Wvl1)-TS_18_GRNF(BS_Wvl2))./(TS_18_GRNF(BS_Wvl1)+TS_18_GRNF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(171*ones(21,1), INDEX1_blood_18_GRNF, 'r', 'filled');

h(1) = plot(172*ones(21,1), INDEX1_AVD_18_GRNF, '*');
h(2) = plot(173*ones(21,1), INDEX1_CO_18_GRNF, '*');
h(3) = plot(174*ones(21,1), INDEX1_COF_18_GRNF, '*');
h(4) = plot(175*ones(21,1), INDEX1_K_18_GRNF, '*');
h(5) = plot(176*ones(21,1), INDEX1_OJ_18_GRNF, '*');
h(6) = plot(177*ones(21,1), INDEX1_PD_18_GRNF, '*');
h(7) = plot(178*ones(21,1), INDEX1_RW_18_GRNF, '*');
h(8) = plot(179*ones(21,1), INDEX1_T_18_GRNF, '*');
h(9) = plot(180*ones(21,1), INDEX1_TS_18_GRNF, '*');
...
%%%%%% 30ML %%
INDEX1_blood_30_GRNF = (blood_30_GRNF(BS_Wvl1)-blood_30_GRNF(BS_Wvl2))./(blood_30_GRNF(BS_Wvl1)+blood_30_GRNF(BS_Wvl2));
INDEX1_AVD_30_GRNF = (AVD_30_GRNF(BS_Wvl1)-AVD_30_GRNF(BS_Wvl2))./(AVD_30_GRNF(BS_Wvl1)+AVD_30_GRNF(BS_Wvl2));
INDEX1_CO_30_GRNF = (CO_30_GRNF(BS_Wvl1)-CO_30_GRNF(BS_Wvl2))./(CO_30_GRNF(BS_Wvl1)+CO_30_GRNF(BS_Wvl2));
INDEX1_COF_30_GRNF = (COF_30_GRNF(BS_Wvl1)-COF_30_GRNF(BS_Wvl2))./(COF_30_GRNF(BS_Wvl1)+COF_30_GRNF(BS_Wvl2));
INDEX1_K_30_GRNF = (K_30_GRNF(BS_Wvl1)-K_30_GRNF(BS_Wvl2))./(K_30_GRNF(BS_Wvl1)+K_30_GRNF(BS_Wvl2));
INDEX1_OJ_30_GRNF = (OJ_30_GRNF(BS_Wvl1)-OJ_30_GRNF(BS_Wvl2))./(OJ_30_GRNF(BS_Wvl1)+OJ_30_GRNF(BS_Wvl2));
INDEX1_PD_30_GRNF = (PD_30_GRNF(BS_Wvl1)-PD_30_GRNF(BS_Wvl2))./(PD_30_GRNF(BS_Wvl1)+PD_30_GRNF(BS_Wvl2));
INDEX1_RW_30_GRNF = (RW_30_GRNF(BS_Wvl1)-RW_30_GRNF(BS_Wvl2))./(RW_30_GRNF(BS_Wvl1)+RW_30_GRNF(BS_Wvl2));
INDEX1_T_30_GRNF = (T_30_GRNF(BS_Wvl1)-T_30_GRNF(BS_Wvl2))./(T_30_GRNF(BS_Wvl1)+T_30_GRNF(BS_Wvl2));
INDEX1_TS_30_GRNF = (TS_30_GRNF(BS_Wvl1)-TS_30_GRNF(BS_Wvl2))./(TS_30_GRNF(BS_Wvl1)+TS_30_GRNF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(181*ones(21,1), INDEX1_blood_30_GRNF, 'r', 'filled');

h(1) = plot(182*ones(21,1), INDEX1_AVD_30_GRNF, '*');
h(2) = plot(183*ones(21,1), INDEX1_CO_30_GRNF, '*');
h(3) = plot(184*ones(21,1), INDEX1_COF_30_GRNF, '*');
h(4) = plot(185*ones(21,1), INDEX1_K_30_GRNF, '*');
h(5) = plot(186*ones(21,1), INDEX1_OJ_30_GRNF, '*');
h(6) = plot(187*ones(21,1), INDEX1_PD_30_GRNF, '*');
h(7) = plot(188*ones(21,1), INDEX1_RW_30_GRNF, '*');
h(8) = plot(189*ones(21,1), INDEX1_T_30_GRNF, '*');
h(9) = plot(190*ones(21,1), INDEX1_TS_30_GRNF, '*');
...
%%%%%% 40ML %%
INDEX1_blood_40_GRNF = (blood_40_GRNF(BS_Wvl1)-blood_40_GRNF(BS_Wvl2))./(blood_40_GRNF(BS_Wvl1)+blood_40_GRNF(BS_Wvl2));
INDEX1_AVD_40_GRNF = (AVD_40_GRNF(BS_Wvl1)-AVD_40_GRNF(BS_Wvl2))./(AVD_40_GRNF(BS_Wvl1)+AVD_40_GRNF(BS_Wvl2));
INDEX1_CO_40_GRNF = (CO_40_GRNF(BS_Wvl1)-CO_40_GRNF(BS_Wvl2))./(CO_40_GRNF(BS_Wvl1)+CO_40_GRNF(BS_Wvl2));
INDEX1_COF_40_GRNF = (COF_40_GRNF(BS_Wvl1)-COF_40_GRNF(BS_Wvl2))./(COF_40_GRNF(BS_Wvl1)+COF_40_GRNF(BS_Wvl2));
INDEX1_K_40_GRNF = (K_40_GRNF(BS_Wvl1)-K_40_GRNF(BS_Wvl2))./(K_40_GRNF(BS_Wvl1)+K_40_GRNF(BS_Wvl2));
INDEX1_OJ_40_GRNF = (OJ_40_GRNF(BS_Wvl1)-OJ_40_GRNF(BS_Wvl2))./(OJ_40_GRNF(BS_Wvl1)+OJ_40_GRNF(BS_Wvl2));
INDEX1_PD_40_GRNF = (PD_40_GRNF(BS_Wvl1)-PD_40_GRNF(BS_Wvl2))./(PD_40_GRNF(BS_Wvl1)+PD_40_GRNF(BS_Wvl2));
INDEX1_RW_40_GRNF = (RW_40_GRNF(BS_Wvl1)-RW_40_GRNF(BS_Wvl2))./(RW_40_GRNF(BS_Wvl1)+RW_40_GRNF(BS_Wvl2));
INDEX1_T_40_GRNF = (T_40_GRNF(BS_Wvl1)-T_40_GRNF(BS_Wvl2))./(T_40_GRNF(BS_Wvl1)+T_40_GRNF(BS_Wvl2));
INDEX1_TS_40_GRNF = (TS_40_GRNF(BS_Wvl1)-TS_40_GRNF(BS_Wvl2))./(TS_40_GRNF(BS_Wvl1)+TS_40_GRNF(BS_Wvl2));
%INDEX1_BLKF8 = [INDEX1_AVD8_BLKF INDEX1_CS8_BLKF INDEX1_C8_BLKF INDEX1_K8_BLKF INDEX1_OJ8_BLKF INDEX1_PD8_BLKF INDEX1_RW8_BLKF INDEX1_T8_BLKF];
%plot(52:59, INDEX1_BLKF8, 'b*');
scatter(191*ones(21,1), INDEX1_blood_40_GRNF, 'r', 'filled');

h(1) = plot(192*ones(21,1), INDEX1_AVD_40_GRNF, '*');
h(2) = plot(193*ones(21,1), INDEX1_CO_40_GRNF, '*');
h(3) = plot(194*ones(21,1), INDEX1_COF_40_GRNF, '*');
h(4) = plot(195*ones(21,1), INDEX1_K_40_GRNF, '*');
h(5) = plot(196*ones(21,1), INDEX1_OJ_40_GRNF, '*');
h(6) = plot(197*ones(21,1), INDEX1_PD_40_GRNF, '*');
h(7) = plot(198*ones(21,1), INDEX1_RW_40_GRNF, '*');
h(8) = plot(199*ones(21,1), INDEX1_T_40_GRNF, '*');
h(9) = plot(200*ones(21,1), INDEX1_TS_40_GRNF, '*');
...
%%%%%%%%%%%%%%%%%   RED Felt   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_4_REDF = (blood_4_REDF(BS_Wvl1)-blood_4_REDF(BS_Wvl2))./(blood_4_REDF(BS_Wvl1)+blood_4_REDF(BS_Wvl2));
INDEX1_AVD_4_REDF = (AVD_4_REDF(BS_Wvl1)-AVD_4_REDF(BS_Wvl2))./(AVD_4_REDF(BS_Wvl1)+AVD_4_REDF(BS_Wvl2));
INDEX1_CO_4_REDF = (CO_4_REDF(BS_Wvl1)-CO_4_REDF(BS_Wvl2))./(CO_4_REDF(BS_Wvl1)+CO_4_REDF(BS_Wvl2));
INDEX1_COF_4_REDF = (COF_4_REDF(BS_Wvl1)-COF_4_REDF(BS_Wvl2))./(COF_4_REDF(BS_Wvl1)+COF_4_REDF(BS_Wvl2));
%INDEX1_K_4_REDF = (K_4_REDF(601)-K2_REDF(851))/(K2_REDF(601)+K2_REDF(851));
INDEX1_OJ_4_REDF = (OJ_4_REDF(BS_Wvl1)-OJ_4_REDF(BS_Wvl2))./(OJ_4_REDF(BS_Wvl1)+OJ_4_REDF(BS_Wvl2));
INDEX1_PD_4_REDF = (PD_4_REDF(BS_Wvl1)-PD_4_REDF(BS_Wvl2))./(PD_4_REDF(BS_Wvl1)+PD_4_REDF(BS_Wvl2));
INDEX1_RW_4_REDF = (RW_4_REDF(BS_Wvl1)-RW_4_REDF(BS_Wvl2))./(RW_4_REDF(BS_Wvl1)+RW_4_REDF(BS_Wvl2));
INDEX1_T_4_REDF = (T_4_REDF(BS_Wvl1)-T_4_REDF(BS_Wvl2))./(T_4_REDF(BS_Wvl1)+T_4_REDF(BS_Wvl2));
INDEX1_TS_4_REDF = (TS_4_REDF(BS_Wvl1)-TS_4_REDF(BS_Wvl2))./(TS_4_REDF(BS_Wvl1)+TS_4_REDF(BS_Wvl2));%INDEX1_TS2_REDF = (TS2_REDF(601)-TS2_REDF(851))/(TS2_REDF(601)+TS2_REDF(851));
...
scatter(151*ones(21,1), INDEX1_blood_4_REDF, 'r', 'filled');

h(1) = plot(152*ones(21,1), INDEX1_AVD_4_REDF, '*');
h(2) = plot(153*ones(21,1), INDEX1_CO_4_REDF, '*');
h(3) = plot(154*ones(21,1), INDEX1_COF_4_REDF, '*');
%h(4) = plot(45, INDEX1_K4_BLKF, '*');
h(5) = plot(156*ones(21,1), INDEX1_OJ_4_REDF, '*');
h(6) = plot(157*ones(21,1), INDEX1_PD_4_REDF, '*');
h(7) = plot(158*ones(21,1), INDEX1_RW_4_REDF, '*');
h(8) = plot(159*ones(21,1), INDEX1_T_4_REDF, '*');
h(9) = plot(160*ones(21,1), INDEX1_TS_4_REDF, '*');
...
INDEX1_blood_8_REDF = (blood_8_REDF(BS_Wvl1)-blood_8_REDF(BS_Wvl2))./(blood_8_REDF(BS_Wvl1)+blood_8_REDF(BS_Wvl2));
INDEX1_AVD_8_REDF = (AVD_8_REDF(BS_Wvl1)-AVD_8_REDF(BS_Wvl2))./(AVD_8_REDF(BS_Wvl1)+AVD_8_REDF(BS_Wvl2));
INDEX1_CO_8_REDF = (CO_8_REDF(BS_Wvl1)-CO_8_REDF(BS_Wvl2))./(CO_8_REDF(BS_Wvl1)+CO_8_REDF(BS_Wvl2));
INDEX1_COF_8_REDF = (COF_8_REDF(BS_Wvl1)-COF_8_REDF(BS_Wvl2))./(COF_8_REDF(BS_Wvl1)+COF_8_REDF(BS_Wvl2));
INDEX1_OJ_8_REDF = (OJ_8_REDF(BS_Wvl1)-OJ_8_REDF(BS_Wvl2))./(OJ_8_REDF(BS_Wvl1)+OJ_8_REDF(BS_Wvl2));
INDEX1_PD_8_REDF = (PD_8_REDF(BS_Wvl1)-PD_8_REDF(BS_Wvl2))./(PD_8_REDF(BS_Wvl1)+PD_8_REDF(BS_Wvl2));
INDEX1_RW_8_REDF = (RW_8_REDF(BS_Wvl1)-RW_8_REDF(BS_Wvl2))./(RW_8_REDF(BS_Wvl1)+RW_8_REDF(BS_Wvl2));
INDEX1_T_8_REDF = (T_8_REDF(BS_Wvl1)-T_8_REDF(BS_Wvl2))./(T_8_REDF(BS_Wvl1)+T_8_REDF(BS_Wvl2));
...
scatter(161*ones(21,1), INDEX1_blood_8_REDF, 'r', 'filled');



h(1) = plot(162*ones(21,1), INDEX1_AVD_8_REDF, '*');
h(2) = plot(163*ones(21,1), INDEX1_CO_8_REDF, '*');
h(3) = plot(164*ones(21,1), INDEX1_COF_8_REDF, '*');
%h(4) = plot(45, INDEX1_K4_BLKF, '*');
h(5) = plot(166*ones(21,1), INDEX1_OJ_8_REDF, '*');
h(6) = plot(167*ones(21,1), INDEX1_PD_8_REDF, '*');
h(7) = plot(168*ones(21,1), INDEX1_RW_8_REDF, '*');
h(8) = plot(169*ones(21,1), INDEX1_T_8_REDF, '*');
...
INDEX1_blood_2_COTNT = (blood_2_COTNT(BS_Wvl1)-blood_2_COTNT(BS_Wvl2))./(blood_2_COTNT(BS_Wvl1)+blood_2_COTNT(BS_Wvl2));
INDEX1_AVD_2_COTNT = (AVD_2_COTNT(BS_Wvl1)-AVD_2_COTNT(BS_Wvl2))./(AVD_2_COTNT(BS_Wvl1)+AVD_2_COTNT(BS_Wvl2));
INDEX1_CO_2_COTNT = (CO_2_COTNT(BS_Wvl1)-CO_2_COTNT(BS_Wvl2))./(CO_2_COTNT(BS_Wvl1)+CO_2_COTNT(BS_Wvl2));
INDEX1_COF_2_COTNT = (COF_2_COTNT(BS_Wvl1)-COF_2_COTNT(BS_Wvl2))./(COF_2_COTNT(BS_Wvl1)+COF_2_COTNT(BS_Wvl2));
INDEX1_K_2_COTNT = (K_2_COTNT(BS_Wvl1)-K_2_COTNT(BS_Wvl2))./(K_2_COTNT(BS_Wvl1)+K_2_COTNT(BS_Wvl2));
INDEX1_OJ_2_COTNT = (OJ_2_COTNT(BS_Wvl1)-OJ_2_COTNT(BS_Wvl2))./(OJ_2_COTNT(BS_Wvl1)+OJ_2_COTNT(BS_Wvl2));
INDEX1_PD_2_COTNT = (PD_2_COTNT(BS_Wvl1)-PD_2_COTNT(BS_Wvl2))./(PD_2_COTNT(BS_Wvl1)+PD_2_COTNT(BS_Wvl2));
INDEX1_RW_2_COTNT = (RW_2_COTNT(BS_Wvl1)-RW_2_COTNT(BS_Wvl2))./(RW_2_COTNT(BS_Wvl1)+RW_2_COTNT(BS_Wvl2));
INDEX1_T_2_COTNT = (T_2_COTNT(BS_Wvl1)-T_2_COTNT(BS_Wvl2))./(T_2_COTNT(BS_Wvl1)+T_2_COTNT(BS_Wvl2));
INDEX1_TS_2_COTNT = (TS_2_COTNT(BS_Wvl1)-TS_2_COTNT(BS_Wvl2))./(TS_2_COTNT(BS_Wvl1)+TS_2_COTNT(BS_Wvl2));
...
scatter(171*ones(21,1), INDEX1_blood_2_COTNT, 'r', 'filled');


h(1) = plot(172*ones(21,1), INDEX1_AVD_2_COTNT, '*');
h(2) = plot(173*ones(21,1), INDEX1_CO_2_COTNT, '*');
h(3) = plot(174*ones(21,1), INDEX1_COF_2_COTNT, '*');
h(4) = plot(175*ones(21,1), INDEX1_K_2_COTNT, '*');
h(5) = plot(176*ones(21,1), INDEX1_OJ_2_COTNT, '*');
h(6) = plot(177*ones(21,1), INDEX1_PD_2_COTNT, '*');
h(7) = plot(178*ones(21,1), INDEX1_RW_2_COTNT, '*');
h(8) = plot(179*ones(21,1), INDEX1_T_2_COTNT, '*');
h(9) = plot(180*ones(21,1), INDEX1_TS_2_COTNT, '*');
...
INDEX1_blood_2_POLY = (blood_2_POLY(BS_Wvl1)-blood_2_POLY(BS_Wvl2))./(blood_2_POLY(BS_Wvl1)+blood_2_POLY(BS_Wvl2));
INDEX1_AVD_2_POLY = (AVD_2_POLY(BS_Wvl1)-AVD_2_POLY(BS_Wvl2))./(AVD_2_POLY(BS_Wvl1)+AVD_2_POLY(BS_Wvl2));
INDEX1_CO_2_POLY = (CO_2_POLY(BS_Wvl1)-CO_2_POLY(BS_Wvl2))./(CO_2_POLY(BS_Wvl1)+CO_2_POLY(BS_Wvl2));
INDEX1_COF_2_POLY = (COF_2_POLY(BS_Wvl1)-COF_2_POLY(BS_Wvl2))./(COF_2_POLY(BS_Wvl1)+COF_2_POLY(BS_Wvl2));
INDEX1_K_2_POLY = (K_2_POLY(BS_Wvl1)-K_2_POLY(BS_Wvl2))./(K_2_POLY(BS_Wvl1)+K_2_POLY(BS_Wvl2));
INDEX1_OJ_2_POLY = (OJ_2_POLY(BS_Wvl1)-OJ_2_POLY(BS_Wvl2))./(OJ_2_POLY(BS_Wvl1)+OJ_2_POLY(BS_Wvl2));
INDEX1_PD_2_POLY = (PD_2_POLY(BS_Wvl1)-PD_2_POLY(BS_Wvl2))./(PD_2_POLY(BS_Wvl1)+PD_2_POLY(BS_Wvl2));
INDEX1_RW_2_POLY = (RW_2_POLY(BS_Wvl1)-RW_2_POLY(BS_Wvl2))./(RW_2_POLY(BS_Wvl1)+RW_2_POLY(BS_Wvl2));
INDEX1_T_2_POLY = (T_2_POLY(BS_Wvl1)-T_2_POLY(BS_Wvl2))./(T_2_POLY(BS_Wvl1)+T_2_POLY(BS_Wvl2));
INDEX1_TS_2_POLY = (TS_2_POLY(BS_Wvl1)-TS_2_POLY(BS_Wvl2))./(TS_2_POLY(BS_Wvl1)+TS_2_POLY(BS_Wvl2));
...
scatter(181*ones(21,1), INDEX1_blood_2_POLY, 'r', 'filled');

h(1) = plot(182*ones(21,1), INDEX1_AVD_2_POLY, '*');
h(2) = plot(183*ones(21,1), INDEX1_CO_2_POLY, '*');
h(3) = plot(184*ones(21,1), INDEX1_COF_2_POLY, '*');
h(4) = plot(185*ones(21,1), INDEX1_K_2_POLY, '*');
h(5) = plot(186*ones(21,1), INDEX1_OJ_2_POLY, '*');
h(6) = plot(187*ones(21,1), INDEX1_PD_2_POLY, '*');
h(7) = plot(188*ones(21,1), INDEX1_RW_2_POLY, '*');
h(8) = plot(189*ones(21,1), INDEX1_T_2_POLY, '*');
h(9) = plot(190*ones(21,1), INDEX1_TS_2_POLY, '*');
...
%%%%%%%%%%%%%%%%%   JEANS   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_2_J = (blood_2_J(BS_Wvl1)-blood_2_J(BS_Wvl2))./(blood_2_J(BS_Wvl1)+blood_2_J(BS_Wvl2));
INDEX1_AVD_2_J = (AVD_2_J(BS_Wvl1)-AVD_2_J(BS_Wvl2))./(AVD_2_J(BS_Wvl1)+AVD_2_J(BS_Wvl2));
INDEX1_CO_2_J = (CO_2_J(BS_Wvl1)-CO_2_J(BS_Wvl2))./(CO_2_J(BS_Wvl1)+CO_2_J(BS_Wvl2));
INDEX1_COF_2_J = (COF_2_J(BS_Wvl1)-COF_2_J(BS_Wvl2))./(COF_2_J(BS_Wvl1)+COF_2_J(BS_Wvl2));
INDEX1_K_2_J = (K_2_J(BS_Wvl1)-K_2_J(BS_Wvl2))./(K_2_J(BS_Wvl1)+K_2_J(BS_Wvl2));
INDEX1_OJ_2_J = (OJ_2_J(BS_Wvl1)-OJ_2_J(BS_Wvl2))./(OJ_2_J(BS_Wvl1)+OJ_2_J(BS_Wvl2));
INDEX1_PD_2_J = (PD_2_J(BS_Wvl1)-PD_2_J(BS_Wvl2))./(PD_2_J(BS_Wvl1)+PD_2_J(BS_Wvl2));
INDEX1_RW_2_J = (RW_2_J(BS_Wvl1)-RW_2_J(BS_Wvl2))./(RW_2_J(BS_Wvl1)+RW_2_J(BS_Wvl2));
INDEX1_T_2_J = (T_2_J(BS_Wvl1)-T_2_J(BS_Wvl2))./(T_2_J(BS_Wvl1)+T_2_J(BS_Wvl2));
INDEX1_TS_2_J = (TS_2_J(BS_Wvl1)-TS_2_J(BS_Wvl2))./(TS_2_J(BS_Wvl1)+TS_2_J(BS_Wvl2));
...
scatter(191*ones(21,1), INDEX1_blood_2_J, 'r', 'filled');


h(1) = plot(192*ones(21,1), INDEX1_AVD_2_J, '*');
h(2) = plot(193*ones(21,1), INDEX1_CO_2_J, '*');
h(3) = plot(194*ones(21,1), INDEX1_COF_2_J, '*');
h(4) = plot(195*ones(21,1), INDEX1_K_2_J, '*');
h(5) = plot(196*ones(21,1), INDEX1_OJ_2_J, '*');
h(6) = plot(197*ones(21,1), INDEX1_PD_2_J, '*');
h(7) = plot(198*ones(21,1), INDEX1_RW_2_J, '*');
h(8) = plot(199*ones(21,1), INDEX1_T_2_J, '*');
h(9) = plot(200*ones(21,1), INDEX1_TS_2_J, '*');
...
%%%%%%%%%%%%%%%%%   WOOD   %%%%%%%%%%%%%%%%%%%%
INDEX1_blood_1_W = (blood_1_WOOD(BS_Wvl1)-blood_1_WOOD(BS_Wvl2))./(blood_1_WOOD(BS_Wvl1)+blood_1_WOOD(BS_Wvl2));
INDEX1_AVD_1_W = (AVD_1_WOOD(BS_Wvl1)-AVD_1_WOOD(BS_Wvl2))./(AVD_1_WOOD(BS_Wvl1)+AVD_1_WOOD(BS_Wvl2));
INDEX1_CO_1_W = (CO_1_WOOD(BS_Wvl1)-CO_1_WOOD(BS_Wvl2))./(CO_1_WOOD(BS_Wvl1)+CO_1_WOOD(BS_Wvl2));
INDEX1_COF_1_W = (COF_1_WOOD(BS_Wvl1)-COF_1_WOOD(BS_Wvl2))./(COF_1_WOOD(BS_Wvl1)+COF_1_WOOD(BS_Wvl2));
INDEX1_K_1_W = (K_1_WOOD(BS_Wvl1)-K_1_WOOD(BS_Wvl2))./(K_1_WOOD(BS_Wvl1)+K_1_WOOD(BS_Wvl2));
INDEX1_OJ_1_W = (OJ_1_WOOD(BS_Wvl1)-OJ_1_WOOD(BS_Wvl2))./(OJ_1_WOOD(BS_Wvl1)+OJ_1_WOOD(BS_Wvl2));
INDEX1_PD_1_W = (PD_1_WOOD(BS_Wvl1)-PD_1_WOOD(BS_Wvl2))./(PD_1_WOOD(BS_Wvl1)+PD_1_WOOD(BS_Wvl2));
INDEX1_RW_1_W = (RW_1_WOOD(BS_Wvl1)-RW_1_WOOD(BS_Wvl2))./(RW_1_WOOD(BS_Wvl1)+RW_1_WOOD(BS_Wvl2));
INDEX1_T_1_W = (T_1_WOOD(BS_Wvl1)-T_1_WOOD(BS_Wvl2))./(T_1_WOOD(BS_Wvl1)+T_1_WOOD(BS_Wvl2));
INDEX1_TS_1_W = (TS_1_WOOD(BS_Wvl1)-TS_1_WOOD(BS_Wvl2))./(TS_1_WOOD(BS_Wvl1)+TS_1_WOOD(BS_Wvl2));
...
scatter(201*ones(21,1), INDEX1_blood_1_W, 'r', 'filled');

h(1) = plot(202*ones(21,1), INDEX1_AVD_1_W, '*');
h(2) = plot(203*ones(21,1), INDEX1_CO_1_W, '*');
h(3) = plot(204*ones(21,1), INDEX1_COF_1_W, '*');
h(4) = plot(205*ones(21,1), INDEX1_K_1_W, '*');
h(5) = plot(206*ones(21,1), INDEX1_OJ_1_W, '*');
h(6) = plot(207*ones(21,1), INDEX1_PD_1_W, '*');
h(7) = plot(208*ones(21,1), INDEX1_RW_1_W, '*');
h(8) = plot(209*ones(21,1), INDEX1_T_1_W, '*');
h(9) = plot(210*ones(21,1), INDEX1_TS_1_W, '*');
...
set(mTB10, 'Position', [47 32 3.9 4])
...
set(mTB11, 'Position', [51 32 3.9 4])
...
set(mTB12, 'Position', [55 32 3.9 4])
...
set(mTB14, 'Position', [59 32 3.9 4])
...
set(mTB15, 'Position', [63 32 3.9 4])
...
set(mTB16, 'Position', [67 32 3.9 4])
...
set(mTB17, 'Position', [71 32 3.9 4])
...
set(mTB24, 'Position', [75 32 3.9 4])
...
set(mTB25, 'Position', [79 32 3.9 4])
...
set(mTB26, 'Position', [83 32 3.9 4])
...
set(mTB27, 'Position', [87 32 3.9 4])
...
set(mTB28, 'Position', [91 32 3.9 4])
...
set(mTB29, 'Position', [95 32 3.9 4])
