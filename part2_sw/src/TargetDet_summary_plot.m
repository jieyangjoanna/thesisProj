function [AUC_PR_allSubstrates_allAlgos, TPR_p0001_allSubstrates_allAlgos] = TargetDet_summary_plot()
...
for i = 1:11
    if i == 1
        ...
        [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_WP, GT_WP);     
    elseif i == 2
        clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
        % ROI
        ...
        [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_WC, GT_WC);
   elseif i == 3
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_GF, GT_GF);
   elseif i == 4
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_GRNF, GT_GRNF);
   elseif i == 5
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_RF, GT_RF);
  elseif i == 6
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_BF, GT_BF);
  elseif i == 7
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_BCInner, GT_BCInner);
  elseif i ==8
        clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
        % ROI
        ...
        [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_BCMid, GT_BCMid);
   elseif i ==9
        clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
        % ROI
        ...
        [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_BCOutter, GT_BCOutter);
   elseif i == 10
       clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
       % ROI
       ...
       [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_J, GT_J);
   elseif i == 11
        clearvars ALGO_image_result ROI ALGO_GT_data ALGO_non_GT_data idx_bckgrd
        % ROI
        ...
        [TPR_p0001_allSubstrates_allAlgos(i,:), AUC_PR_allSubstrates_allAlgos(i,:), AUC_ROC_allSubstrates_allAlgos(i,:)]= algo_image_plot(I0, ROI, t_W, GT_W);
    end
end
